...
function about() {
  return (
    <>
        <Head>
            <title> DigvijaySinghNagarkoti | About Page </title>
...
new and innovative ways to bring my clients' visions to life.
            ...
            I believe that innovation is about finding solutions for the problems and making things look easy and pretty. it's about solving problems and 
creating intuitive, enjoyable experiences for users.
            </p>

            <p className='font-medium'>
            Whether I'm working on Computer vision, website, or 
...
every project I work on. I look forward to the opportunity to bring my skills and passion to your next project.
            ...
            <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 xl:col-span-4 md:order-1 md:col-span-8'>
                ...
                <Image src={profilePic} alt="DigvijaySinghNagarkoti" className="w-full h-auto rounded-2xl"  priority
